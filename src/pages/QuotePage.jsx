...
import { Calculator, Car, Home, Shield, DollarSign, CheckCircle, AlertCircle, Loader, Search, CreditCard, FileText, Lock, Share2, Copy, Building2, Link2, User } from 'lucide-react'
  ...
  const handleVSCSubmit = async (e) => {
    ...
    try {
      ...
      const quoteData = {
        ...
        mileage_allowance: vscForm.mileage_allowance === 'unlimited' ? 'unlimited' : parseInt(vscForm.mileage_allowance), // NEW
